...
class CommandKernelMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'cms:make:command-kernel';
     ...
     * @var string
     */
    protected $description = 'Create a new command kernel for the specified module.';
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub('/command-kernel.stub', [
